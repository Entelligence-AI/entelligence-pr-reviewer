...
export const COMMENT_GREETING = `${getInput('bot_icon')}   Entelligence.AI`

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by OSS Entelligence.AI -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by OSS Entelligence.AI -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by OSS Entelligence.AI -->'

export const IN_PROGRESS_START_TAG =
  '<!-- This is an auto-generated comment: summarize review in progress by OSS Entelligence.AI -->'

export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by OSS Entelligence.AI -->'
...
export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by OSS Entelligence.AI -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by OSS Entelligence.AI -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by OSS Entelligence.AI -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by OSS Entelligence.AI -->`
